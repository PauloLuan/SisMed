 ...
 */
public class PacienteEditSaveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Default constructor.
	 */
	public PacienteEditSaveServlet() {
	...
	protected void doPost(HttpServletRequest request,
		...
		a.setIdPaciente(Integer.parseInt(request.getParameter("idPaciente")));
		...
		if(resp == 1)
			response.sendRedirect("pacientes.jsp?msg=Paciente alterado com sucesso!");
		else
			response.sendRedirect("pacientes.jsp?msg2=Paciente não alterado!");
